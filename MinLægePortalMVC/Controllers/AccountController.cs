    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    string bearerToken = RestClientManager.RestClientManager.GetToken(model.UserId, model.Password);
                ...
                default:
                    ModelState.AddModelError("", "Ikke gyldigt login. Prøv igen");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    ModelState.AddModelError("", "Ikke gyldigt kode.");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> RegisterPatient(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleResult = UserManager.AddToRole(user.Id, "Patient");
                    Patient patient = new Patient(model.UserId, model.FirstName, model.LastName, model.Phone, model.Address, model.ZipCode, model.CVR);
        ...
        public async Task<ActionResult> RegisterDoctor(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleResult = UserManager.AddToRole(user.Id, "Doctor");
                    Doctor doctor = new Doctor(model.FirstName, model.LastName, model.Phone, model.Address, model.ZipCode, model.UserId, model.CVR);
